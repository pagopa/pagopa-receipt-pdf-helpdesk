...
import it.gov.pagopa.receipt.pdf.helpdesk.client.PDVTokenizerClient;
import it.gov.pagopa.receipt.pdf.helpdesk.client.impl.PDVTokenizerClientImpl;
import it.gov.pagopa.receipt.pdf.helpdesk.exception.PDVTokenizerException;
import it.gov.pagopa.receipt.pdf.helpdesk.model.tokenizer.ErrorMessage;
import it.gov.pagopa.receipt.pdf.helpdesk.model.tokenizer.ErrorResponse;
import it.gov.pagopa.receipt.pdf.helpdesk.model.tokenizer.PiiResource;
import it.gov.pagopa.receipt.pdf.helpdesk.model.tokenizer.TokenResource;
import it.gov.pagopa.receipt.pdf.helpdesk.service.PDVTokenizerService;
